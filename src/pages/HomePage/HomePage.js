...
const BANNER_ENTRADAS = getPublicUrl('Imagenes', 'entradas.png');
...
export default function HomePage({ onOpenAssistant }) {
  ...
  return (
    <>
      ...
      <div className="tienda-main">
        <Header variant="home" user={currentUser} onOpenAssistant={onOpenAssistant} />
            ...
            <div className="promo-banners-grid">
              <div className="promo-item promo-item--gradient">
                <div className="promo-banner-content">
                  <p className="promo-banner-title">Viví el show de Rosalía con hasta 40% off usando tus puntos acumulados</p>
                  <a href="#" className="promo-banner-btn">Ver entradas</a>
                </div>
              </div>
              <div className="promo-item promo-item--image">
                <img src={BANNER_ENTRADAS} alt="" className="promo-item-img" />
              </div>
              <div className="promo-item promo-item--image promo-item--brand-bg">
                <img src={BANNER_ROSALIA} alt="" className="promo-item-img" />
              </div>
            </div>
          </section>
        </main>
